...
/**
 * Normal form base class.
 *
 * @method Normal getObject() Returns the current form's model object
 *
 * @package    galeno
 * @subpackage form
 * @author     Enimados
 ...
 */
abstract class BaseNormalForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('normal[%s]');
